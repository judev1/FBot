...
class FBot_Cogs(commands.Cog):
    ...
    async def _Commands(self, ctx):
        ...
        embed = discord.Embed(title="FBot Commands", description="**Write `FBot ` (the prefix) however you want, I don't care**\n"
                                                                 ...
                                                                 "`status` `server`: **NEW** *Gives an overview of the status for the server*\n"
                                                                 "`status` `server` `mod`: **NEW ADMIN ONLY** *Displays the status for hidden channels too*\n"
                                                                 ...
                                                                 "`pn`/`patchnotes` `<ver>`/`list`: *Gives you the patchnotes for a version, use recent for the most recent version*\n"
                                                                 "\n**Link Commands**\n"
